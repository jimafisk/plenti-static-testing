...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-a4f9c2e4.js').then(draw)).on("/:slug", () => import('./pages-433f605c.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-04c93844.js').then(draw)).listen();
...
//# sourceMappingURL=main-388d4367.js.map
