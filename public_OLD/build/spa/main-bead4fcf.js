...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-e840463f.js').then(draw)).on("/:slug", () => import('./pages-8f5fd32f.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-532cfd3b.js').then(draw)).listen();
...
//# sourceMappingURL=main-bead4fcf.js.map
