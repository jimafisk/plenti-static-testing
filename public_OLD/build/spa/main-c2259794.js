...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-7d3a5024.js').then(draw)).on("/:slug", () => import('./pages-a86b0cc9.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-99fcd2c1.js').then(draw)).listen();
...
//# sourceMappingURL=main-c2259794.js.map
