...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-5f8cb50a.js').then(draw)).on("/:slug", () => import('./Pages-a4339062.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-c8e10d9a.js').then(draw)).listen();
...
//# sourceMappingURL=main-9fae0ac4.js.map
