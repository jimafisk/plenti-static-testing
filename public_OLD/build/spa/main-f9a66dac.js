...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-ecaa0d1f.js').then(draw)).on("/:slug", () => import('./pages-3233521b.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-38b528b8.js').then(draw)).listen();
...
//# sourceMappingURL=main-f9a66dac.js.map
