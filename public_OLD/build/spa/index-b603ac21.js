...
// (14:2) {#if node.type == 'blog'}
function create_if_block(ctx) {
	let li;
	let a;
	let t_value = /*node*/ ctx[2].fields.title + "";
	let t;
	let a_href_value;
	...
	const block = {
		c: function create() {
			...
			add_location(a, file$1, 14, 10, 368);
			add_location(li, file$1, 14, 6, 364);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*allNodes*/ 2 && t_value !== (t_value = /*node*/ ctx[2].fields.title + "")) set_data_dev(t, t_value);
...
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(13:2) {#each allNodes as node}",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file$1, 9, 14, 170);
			add_location(p, file$1, 9, 1, 157);
			add_location(h3, file$1, 10, 1, 268);
			add_location(ul, file$1, 11, 2, 298);
...
//# sourceMappingURL=index-b603ac21.js.map
