...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-8b2cc37b.js').then(draw)).on("/:slug", () => import('./pages-c341c787.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-b64039d9.js').then(draw)).listen();
...
//# sourceMappingURL=main-be93b144.js.map
