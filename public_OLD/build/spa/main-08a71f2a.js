...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-3144590b.js').then(draw)).on("/:slug", () => import('./Pages-45521940.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-c5d2a5e0.js').then(draw)).listen();
...
//# sourceMappingURL=main-08a71f2a.js.map
