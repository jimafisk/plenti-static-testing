...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-a2425f4b.js').then(draw)).on("/:slug", () => import('./pages-5871b401.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-f1f43e55.js').then(draw)).listen();
...
//# sourceMappingURL=main-05cffc6f.js.map
