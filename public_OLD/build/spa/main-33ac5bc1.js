...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(nav, "class", "svelte-1b37ejm");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(footer, "class", "svelte-clabrq");
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-clbvjp");
			add_location(main, file$3, 13, 2, 293);
			attr_dev(body, "class", "svelte-clbvjp");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-c29dc317.js').then(draw)).on("/:slug", () => import('./pages-d3c66677.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-3599db40.js').then(draw)).listen();
...
//# sourceMappingURL=main-33ac5bc1.js.map
