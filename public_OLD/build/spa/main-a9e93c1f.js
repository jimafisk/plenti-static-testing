...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-ab1b6b7f.js').then(draw)).on("/:slug", () => import('./pages-4ad16726.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-fb0dc1f5.js').then(draw)).listen();
...
//# sourceMappingURL=main-a9e93c1f.js.map
