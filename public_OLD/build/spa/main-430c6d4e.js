...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-3d8ac936.js').then(draw)).on("/:slug", () => import('./pages-26ff85f7.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-16a3f0ef.js').then(draw)).listen();
...
//# sourceMappingURL=main-430c6d4e.js.map
