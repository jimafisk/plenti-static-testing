...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-c3a61e40.js').then(draw)).on("/:slug", () => import('./pages-9d745657.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-79cc6292.js').then(draw)).listen();
...
//# sourceMappingURL=main-e8cf6af7.js.map
