...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-6a27cc03.js').then(draw)).on("/:slug", () => import('./pages-7b9ed15f.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-2086d7c8.js').then(draw)).listen();
...
//# sourceMappingURL=main-3a9d2ffa.js.map
