...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-608a9c42.js').then(draw)).on("/:slug", () => import('./Pages-2088daf3.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-0d9600ef.js').then(draw)).listen();
...
//# sourceMappingURL=main-d62f61b1.js.map
