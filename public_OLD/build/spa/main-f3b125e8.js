...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-684d03fc.js').then(draw)).on("/:slug", () => import('./pages-78ab4968.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-62521b0b.js').then(draw)).listen();
...
//# sourceMappingURL=main-f3b125e8.js.map
