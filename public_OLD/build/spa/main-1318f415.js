...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-e502a28a.js').then(draw)).on("/:slug", () => import('./pages-f7c769d6.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-5c72e811.js').then(draw)).listen();
...
//# sourceMappingURL=main-1318f415.js.map
