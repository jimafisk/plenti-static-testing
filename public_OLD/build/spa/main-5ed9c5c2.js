...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-22389060.js').then(draw)).on("/:slug", () => import('./Pages-df5832f2.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-bb3cc00d.js').then(draw)).listen();
...
//# sourceMappingURL=main-5ed9c5c2.js.map
