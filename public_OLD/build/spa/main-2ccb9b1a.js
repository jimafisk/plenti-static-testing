...
/* layout/global/MakeTitle.svelte generated by Svelte v3.20.1 */
...
function instance$2($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<MakeTitle> was created with unknown prop '${key}'`);
	});

	let { $$slots = {}, $$scope } = $$props;
	validate_slots("MakeTitle", $$slots, []);
	$$self.$capture_state = () => ({ makeTitle });
	return [];
}

class MakeTitle extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			t2 = text(t2_value);
			t3 = text(/*Route*/ ctx[0]);
			add_location(h1, file$2, 14, 4, 263);
			add_location(main, file$2, 13, 2, 252);
			add_location(body, file$2, 11, 0, 233);
			attr_dev(html, "lang", "en");
			add_location(html, file$2, 9, 0, 174);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-4a6c36d9.js').then(draw)).on("/:slug", () => import('./Pages-18864dec.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-81c6b147.js').then(draw)).listen();
...
//# sourceMappingURL=main-2ccb9b1a.js.map
