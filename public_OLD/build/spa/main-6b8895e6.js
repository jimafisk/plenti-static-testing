...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a2, file$1, 4, 4, 116);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-3834fed7.js').then(draw)).on("/:slug", () => import('./pages-4e1ab09d.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-96f7d49f.js').then(draw)).listen();
...
//# sourceMappingURL=main-6b8895e6.js.map
