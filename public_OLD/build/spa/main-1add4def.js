...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-ef04f9a6.js').then(draw)).on("/:slug", () => import('./Pages-00be301a.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-33f63657.js').then(draw)).listen();
...
//# sourceMappingURL=main-1add4def.js.map
