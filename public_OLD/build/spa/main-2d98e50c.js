...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-b0a4b149.js').then(draw)).on("/:slug", () => import('./Pages-faaa7c32.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-4902105b.js').then(draw)).listen();
...
//# sourceMappingURL=main-2d98e50c.js.map
