...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-b4629c5b.js').then(draw)).on("/:slug", () => import('./pages-8fcc3813.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-135987e5.js').then(draw)).listen();
...
//# sourceMappingURL=main-3fc40f2e.js.map
