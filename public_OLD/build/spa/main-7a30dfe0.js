...
/* layout/ejected/ClientRouter.svelte generated by Svelte v3.20.1 */
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-e7adf442.js').then(draw)).on("/:slug", () => import('./Pages-3dc42226.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-5edf320e.js').then(draw)).listen();
	onDestroy(router.unlisten);
	const writable_props = [];

	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ClientRouter> was created with unknown prop '${key}'`);
	});

	let { $$slots = {}, $$scope } = $$props;
	validate_slots("ClientRouter", $$slots, []);
...
class ClientRouter extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
const app = replaceContainer( ClientRouter, {
...
//# sourceMappingURL=main-7a30dfe0.js.map
