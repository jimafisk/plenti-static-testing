...
class Content {
    ...
    static getAllNodes() {
      let content$1 = content.map(node => {
        return node;
      });
      return content$1;
    }
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$2, 25, 2, 673);
			add_location(body, file$2, 23, 0, 654);
			attr_dev(html, "lang", "en");
			add_location(html, file$2, 21, 0, 595);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-525f2316.js').then(draw)).on("/:slug", () => import('./Pages-a0d1809a.js').then(draw)).listen();
...
export { SvelteComponentDev as S, app as a, add_location as b, insert_dev as c, dispatch_dev as d, element as e, detach_dev as f, space as g, create_component as h, init as i, attr_dev as j, append_dev as k, set_data_dev as l, mount_component as m, noop as n, transition_in as o, transition_out as p, destroy_component as q, validate_each_argument as r, safe_not_equal as s, text as t, empty as u, validate_slots as v, destroy_each as w };
//# sourceMappingURL=main-dccc2592.js.map
