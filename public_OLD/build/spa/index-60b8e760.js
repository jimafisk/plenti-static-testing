...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			div2 = element("div");
			attr_dev(div0, "class", "grid-item svelte-w9kqja");
			add_location(div0, file, 1, 2, 21);
			attr_dev(div1, "class", "grid-item svelte-w9kqja");
			add_location(div1, file, 2, 2, 53);
			attr_dev(div2, "class", "grid-item svelte-w9kqja");
			add_location(div2, file, 3, 2, 85);
			attr_dev(div3, "class", "grid svelte-w9kqja");
...
//# sourceMappingURL=index-60b8e760.js.map
