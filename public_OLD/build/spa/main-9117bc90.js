...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-5f6187cd.js').then(draw)).on("/:slug", () => import('./pages-7acfd4ab.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-49292d7c.js').then(draw)).listen();
...
//# sourceMappingURL=main-9117bc90.js.map
