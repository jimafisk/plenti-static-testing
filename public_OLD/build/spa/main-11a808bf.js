...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-b3a471a0.js').then(draw)).on("/:slug", () => import('./Pages-36b90126.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-47b14a9b.js').then(draw)).listen();
...
//# sourceMappingURL=main-11a808bf.js.map
