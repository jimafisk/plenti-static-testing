...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file$2, 25, 2, 677);
			add_location(body, file$2, 23, 0, 658);
			attr_dev(html, "lang", "en");
			add_location(html, file$2, 21, 0, 599);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-54f87ed5.js').then(draw)).on("/:slug", () => import('./Pages-51b25eb6.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-f7d93cb2.js').then(draw)).listen();
...
//# sourceMappingURL=main-5a05e89f.js.map
