...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(body, "class", "svelte-1kxqceh");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-ad81f11c.js').then(draw)).on("/:slug", () => import('./pages-d6919071.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-3a8518b8.js').then(draw)).listen();
...
//# sourceMappingURL=main-cb57e9be.js.map
