...
const makeTitle = filename => {
	//export function makeTitle(filename) {
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-438e2072.js').then(draw)).on("/:slug", () => import('./Pages-b6b80783.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-2bb533f8.js').then(draw)).listen();
...
//# sourceMappingURL=main-ed8847f0.js.map
