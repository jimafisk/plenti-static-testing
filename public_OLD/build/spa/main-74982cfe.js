...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-18wrg6j");
			add_location(main, file$3, 13, 2, 293);
			attr_dev(body, "class", "svelte-18wrg6j");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-c1878520.js').then(draw)).on("/:slug", () => import('./pages-d39260b1.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-8d5af96d.js').then(draw)).listen();
...
//# sourceMappingURL=main-74982cfe.js.map
