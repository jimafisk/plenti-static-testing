...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-iizffr");
			add_location(main, file$3, 13, 2, 293);
			attr_dev(body, "class", "svelte-iizffr");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-2cf37378.js').then(draw)).on("/:slug", () => import('./pages-81047e1f.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-48ed7ed2.js').then(draw)).listen();
...
//# sourceMappingURL=main-31ea03e1.js.map
