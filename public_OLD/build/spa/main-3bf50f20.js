...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-0e392661.js').then(draw)).on("/:slug", () => import('./Pages-faefd209.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-07c790dc.js').then(draw)).listen();
...
//# sourceMappingURL=main-3bf50f20.js.map
