...
function create_fragment$3(ctx) {
	...
	const head = new Head({
			props: {
				title: /*makeTitle*/ ctx[3](/*node*/ ctx[1].filename)
			},
			$$inline: true
		});
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			const head_changes = {};
			if (dirty & /*node*/ 2) head_changes.title = /*makeTitle*/ ctx[3](/*node*/ ctx[1].filename);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	return [Route, node, allNodes, makeTitle];
}
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-22a3dd0c.js').then(draw)).on("/:slug", () => Promise.resolve().then(function () { return Pages$1; }).then(draw)).on("/blog/:slug", () => import('./BlogPosts-ccd7fb9d.js').then(draw)).listen();
...
//# sourceMappingURL=main-ecde9a6d.js.map
