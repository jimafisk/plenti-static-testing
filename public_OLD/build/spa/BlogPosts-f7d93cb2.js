...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a, "href", "/");
			add_location(a, file, 7, 0, 112);
			add_location(strong0, file, 9, 0, 144);
			add_location(span0, file, 9, 23, 167);
			add_location(strong1, file, 10, 0, 188);
			add_location(span1, file, 10, 22, 210);
			add_location(div, file, 8, 0, 138);
			add_location(h3, file, 13, 0, 245);
		},
...
//# sourceMappingURL=BlogPosts-f7d93cb2.js.map
