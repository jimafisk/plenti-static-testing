...
function create_each_block(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (/*node*/ ctx[1].fields.title) if_block.p(ctx, dirty);
		},
		d: function destroy(detaching) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$2, 4, 2, 46);
			attr_dev(footer, "class", "svelte-1r80lf6");
			add_location(footer, file$2, 3, 0, 35);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-46d68f2d.js').then(draw)).on("/:slug", () => import('./pages-93d56328.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-8355a885.js').then(draw)).listen();
...
//# sourceMappingURL=main-4e1d97c2.js.map
