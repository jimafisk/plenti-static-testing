...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-60b8e760.js').then(draw)).on("/:slug", () => import('./pages-2e3d1a61.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-3fc1adb0.js').then(draw)).listen();
...
//# sourceMappingURL=main-4a6f1df5.js.map
