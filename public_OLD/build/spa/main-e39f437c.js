...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(body, "class", "svelte-1d5lu");
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-632a4ab4.js').then(draw)).on("/:slug", () => import('./pages-7cec5e4e.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-cf3383cd.js').then(draw)).listen();
...
//# sourceMappingURL=main-e39f437c.js.map
