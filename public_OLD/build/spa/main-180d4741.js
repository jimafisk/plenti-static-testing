...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-e09f6fb4.js').then(draw)).on("/:slug", () => import('./pages-cfa8edf6.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-200ac599.js').then(draw)).listen();
...
//# sourceMappingURL=main-180d4741.js.map
