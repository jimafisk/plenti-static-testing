...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(link1, file, 11, 2, 294);
			attr_dev(link2, "rel", "stylesheet");
			attr_dev(link2, "href", "/build/bundle.css");
			add_location(link2, file, 12, 2, 351);
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(a0, "href", "/");
			add_location(a0, file$1, 2, 21, 53);
			attr_dev(span, "id", "brand");
			attr_dev(span, "class", "svelte-1pz3ylm");
			add_location(span, file$1, 2, 4, 36);
			attr_dev(a1, "href", "/about");
			add_location(a1, file$1, 3, 4, 85);
			attr_dev(a2, "href", "/anything");
			add_location(a2, file$1, 4, 4, 122);
			attr_dev(div, "class", "container svelte-1pz3ylm");
			add_location(div, file$1, 1, 2, 8);
			attr_dev(nav, "class", "svelte-1pz3ylm");
...
const file$2 = "layout/global/footer.svelte";
...
function create_if_block(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*allNodes*/ 1 && t0_value !== (t0_value = /*node*/ ctx[1].fields.title + "")) set_data_dev(t0, t0_value);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(8:6) {#if node.fields.title}",
		ctx
	});
...
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(7:4) {#each allNodes as node}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$2, 5, 4, 81);
			attr_dev(div, "class", "container");
			add_location(div, file$2, 4, 2, 53);
			attr_dev(footer, "class", "svelte-n69rq5");
			add_location(footer, file$2, 3, 0, 42);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
class Footer extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { allNodes: 0 });
		...
		if (/*allNodes*/ ctx[0] === undefined && !("allNodes" in props)) {
			console.warn("<Footer> was created without expected prop 'allNodes'");
		}
	}
...
const file$3 = "layout/global/html.svelte";
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br, file$3, 16, 6, 414);
			add_location(summary, file$3, 18, 8, 445);
			add_location(pre, file$3, 19, 8, 498);
			add_location(details, file$3, 17, 6, 427);
			attr_dev(div, "class", "container");
			add_location(div, file$3, 14, 4, 316);
			attr_dev(main, "class", "svelte-8fbqk6");
			add_location(main, file$3, 13, 2, 305);
			attr_dev(body, "class", "svelte-8fbqk6");
			add_location(body, file$3, 11, 0, 286);
			attr_dev(html, "lang", "en");
			add_location(html, file$3, 9, 0, 227);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*Route*/ 1) set_data_dev(t6, /*Route*/ ctx[0]);
...
class Html extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { Route: 0, node: 1, allNodes: 2 });
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-9715ad82.js').then(draw)).on("/:slug", () => import('./pages-25aabf21.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-413e8718.js').then(draw)).listen();
...
export { SvelteComponentDev as S, app as a, validate_slots as b, insert_dev as c, dispatch_dev as d, empty as e, detach_dev as f, element as g, attr_dev as h, init as i, add_location as j, destroy_each as k, append_dev as l, set_data_dev as m, noop as n, space as o, create_component as p, mount_component as q, transition_in as r, safe_not_equal as s, text as t, transition_out as u, validate_each_argument as v, destroy_component as w };
//# sourceMappingURL=main-04a40532.js.map
