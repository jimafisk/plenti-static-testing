...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(footer, "class", "svelte-ch1pl1");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-7271911c.js').then(draw)).on("/:slug", () => import('./pages-248f3a4a.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-8a392b1a.js').then(draw)).listen();
...
//# sourceMappingURL=main-ce9d9b71.js.map
