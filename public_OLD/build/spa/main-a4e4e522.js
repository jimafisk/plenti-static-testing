...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-0ae55ffc.js').then(draw)).on("/:slug", () => import('./Pages-e362c87b.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-a43bd441.js').then(draw)).listen();
...
//# sourceMappingURL=main-a4e4e522.js.map
