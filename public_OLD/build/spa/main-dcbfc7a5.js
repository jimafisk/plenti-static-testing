...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-892081ae.js').then(draw)).on("/:slug", () => import('./Pages-2bc7d6ce.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-19d5a0f1.js').then(draw)).listen();
...
//# sourceMappingURL=main-dcbfc7a5.js.map
