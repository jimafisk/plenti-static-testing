...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-1a8e7c06.js').then(draw)).on("/:slug", () => import('./pages-d43009ff.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-933096ea.js').then(draw)).listen();
...
//# sourceMappingURL=main-336a6ec3.js.map
