...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-e3d02c79.js').then(draw)).on("/:slug", () => import('./pages-0d196beb.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-86691f3e.js').then(draw)).listen();
...
//# sourceMappingURL=main-aba2303d.js.map
