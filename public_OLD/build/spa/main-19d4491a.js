...
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(7:4) {#if node.fields.title}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$2, 4, 2, 53);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-591e0ed6.js').then(draw)).on("/:slug", () => import('./pages-f6b3cfee.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-4178e0fd.js').then(draw)).listen();
...
//# sourceMappingURL=main-19d4491a.js.map
