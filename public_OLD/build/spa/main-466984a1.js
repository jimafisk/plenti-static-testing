...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file$2, 14, 4, 265);
			add_location(summary, file$2, 16, 6, 310);
			add_location(pre, file$2, 17, 6, 361);
			add_location(details, file$2, 15, 4, 294);
			add_location(main, file$2, 13, 2, 254);
			add_location(body, file$2, 11, 0, 235);
			attr_dev(html, "lang", "en");
			add_location(html, file$2, 9, 0, 176);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-b8d2f3da.js').then(draw)).on("/:slug", () => import('./Pages-a56f2129.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-efca7047.js').then(draw)).listen();
...
//# sourceMappingURL=main-466984a1.js.map
