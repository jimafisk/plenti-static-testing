...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-0cd20f2b.js').then(draw)).on("/:slug", () => import('./pages-28f0dea0.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-0f6a4ac7.js').then(draw)).listen();
...
//# sourceMappingURL=main-95efccd2.js.map
