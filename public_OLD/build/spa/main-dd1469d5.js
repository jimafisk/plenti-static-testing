...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(nav, "class", "svelte-eemt1h");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-598152ae.js').then(draw)).on("/:slug", () => import('./pages-b94b0f81.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-f17af473.js').then(draw)).listen();
...
//# sourceMappingURL=main-dd1469d5.js.map
