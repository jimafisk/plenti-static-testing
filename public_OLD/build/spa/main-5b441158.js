...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(pre, file$2, 15, 4, 296);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-d31a5fa0.js').then(draw)).on("/:slug", () => import('./Pages-5d559b29.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-0ddd44ca.js').then(draw)).listen();
...
//# sourceMappingURL=main-5b441158.js.map
