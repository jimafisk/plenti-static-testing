...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-84b2d5e2.js').then(draw)).on("/:slug", () => import('./Pages-fb66f4b8.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-8ce185f6.js').then(draw)).listen();
...
//# sourceMappingURL=main-0c31bf9f.js.map
