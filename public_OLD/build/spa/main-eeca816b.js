...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(summary, file$3, 17, 8, 420);
			add_location(pre, file$3, 18, 8, 473);
			add_location(details, file$3, 16, 6, 402);
			attr_dev(div, "class", "container");
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*Route*/ 1) set_data_dev(t5, /*Route*/ ctx[0]);
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-b603ac21.js').then(draw)).on("/:slug", () => import('./pages-7d0b7f74.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-9653e70b.js').then(draw)).listen();
...
//# sourceMappingURL=main-eeca816b.js.map
