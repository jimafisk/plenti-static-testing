...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-db961887.js').then(draw)).on("/:slug", () => import('./pages-dd7dab18.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-28fbaf28.js').then(draw)).listen();
...
//# sourceMappingURL=main-379d1ea4.js.map
