...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-826df999.js').then(draw)).on("/:slug", () => import('./pages-4cb9c1b6.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-15ab9f5b.js').then(draw)).listen();
...
//# sourceMappingURL=main-4aafeaba.js.map
