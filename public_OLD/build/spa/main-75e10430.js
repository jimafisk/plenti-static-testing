...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-41393e7f.js').then(draw)).on("/:slug", () => import('./Pages-47acebf8.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-3e1053ce.js').then(draw)).listen();
...
//# sourceMappingURL=main-75e10430.js.map
