...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-jjk3cq");
			add_location(main, file$3, 13, 2, 293);
			attr_dev(body, "class", "svelte-jjk3cq");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-8f2cc9d2.js').then(draw)).on("/:slug", () => import('./pages-5f3ba601.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-10d0b5ec.js').then(draw)).listen();
...
//# sourceMappingURL=main-0dcd2b84.js.map
