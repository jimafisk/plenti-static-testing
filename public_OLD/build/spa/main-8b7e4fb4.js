...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-68c63151.js').then(draw)).on("/:slug", () => import('./pages-fdca73ac.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-3f2ed95f.js').then(draw)).listen();
...
//# sourceMappingURL=main-8b7e4fb4.js.map
