...
// (4:4) {#if node.fields.title}
function create_if_block(ctx) {
	let a;
	let t0_value = /*node*/ ctx[0].fields.title + "";
	let t0;
	let a_href_value;
	let t1;
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = text(" ");
			attr_dev(a, "href", a_href_value = /*node*/ ctx[0].path);
			add_location(a, file$2, 4, 6, 96);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(4:4) {#if node.fields.title}",
		ctx
	});
...
// (3:2) {#each allNodes as node}
function create_each_block(ctx) {
	let if_block_anchor;
	let if_block = /*node*/ ctx[0].fields.title && create_if_block(ctx);
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (/*node*/ ctx[0].fields.title) if_block.p(ctx, dirty);
		},
		d: function destroy(detaching) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(3:2) {#each allNodes as node}",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$2, 1, 2, 11);
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(summary, file$3, 15, 6, 320);
			add_location(pre, file$3, 16, 6, 371);
			add_location(details, file$3, 14, 4, 304);
			attr_dev(main, "class", "svelte-1ccvz8u");
			add_location(main, file$3, 13, 2, 293);
			attr_dev(body, "class", "svelte-1ccvz8u");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-5b884c40.js').then(draw)).on("/:slug", () => import('./pages-c638c46d.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-da47d97d.js').then(draw)).listen();
...
//# sourceMappingURL=main-2d84bdf3.js.map
