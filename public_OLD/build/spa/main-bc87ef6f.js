...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-aeb7f246.js').then(draw)).on("/:slug", () => import('./pages-24875dd1.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-5d824226.js').then(draw)).listen();
...
//# sourceMappingURL=main-bc87ef6f.js.map
