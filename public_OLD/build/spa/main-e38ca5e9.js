...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-3fa9ad6b.js').then(draw)).on("/:slug", () => import('./pages-4219cbe5.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-0d0e0ba7.js').then(draw)).listen();
...
//# sourceMappingURL=main-e38ca5e9.js.map
