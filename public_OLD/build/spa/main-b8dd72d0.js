...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-47cd21e2.js').then(draw)).on("/:slug", () => import('./Pages-1001509b.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-eef7c75d.js').then(draw)).listen();
...
//# sourceMappingURL=main-b8dd72d0.js.map
