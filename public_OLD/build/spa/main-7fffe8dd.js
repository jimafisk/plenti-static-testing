...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(br, file$3, 16, 6, 402);
			add_location(summary, file$3, 18, 8, 433);
			add_location(pre, file$3, 19, 8, 486);
			add_location(details, file$3, 17, 6, 415);
			attr_dev(div, "class", "container");
			add_location(div, file$3, 14, 4, 304);
			attr_dev(main, "class", "svelte-8fbqk6");
			add_location(main, file$3, 13, 2, 293);
			attr_dev(body, "class", "svelte-8fbqk6");
			add_location(body, file$3, 11, 0, 274);
			attr_dev(html, "lang", "en");
			add_location(html, file$3, 9, 0, 215);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-f769ab57.js').then(draw)).on("/:slug", () => import('./pages-1b4cccfa.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-5061793b.js').then(draw)).listen();
...
//# sourceMappingURL=main-7fffe8dd.js.map
