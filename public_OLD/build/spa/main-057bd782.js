...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(nav, "class", "svelte-1uco9ju");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-26ba8fad.js').then(draw)).on("/:slug", () => import('./pages-25b96e3a.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-ee514506.js').then(draw)).listen();
...
//# sourceMappingURL=main-057bd782.js.map
