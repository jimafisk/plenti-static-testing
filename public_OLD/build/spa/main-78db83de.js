...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-826f805f.js').then(draw)).on("/:slug", () => import('./Pages-b2689747.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-a1837d2b.js').then(draw)).listen();
...
//# sourceMappingURL=main-78db83de.js.map
