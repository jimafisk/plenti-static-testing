...
const file$2 = "layout/content/Pages.svelte";
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file$2, 5, 0, 74);
			add_location(p, file$2, 6, 0, 91);
			attr_dev(a, "href", "/");
			add_location(a, file$2, 7, 0, 113);
			add_location(strong0, file$2, 9, 0, 145);
			add_location(span0, file$2, 9, 23, 168);
			add_location(strong1, file$2, 10, 0, 189);
			add_location(span1, file$2, 10, 22, 211);
			add_location(div, file$2, 8, 0, 139);
			add_location(h3, file$2, 13, 0, 246);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
class Pages extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { allNodes: 2, title: 0, description: 1 });
...
function create_fragment$3(ctx) {
	...
	let main;
	let h1;
	let t2_value = /*node*/ ctx[1].filename + "";
	let t2;
	let t3;
	let current;
	...
	const head = new Head({
			props: {
				title: /*makeTitle*/ ctx[2](/*node*/ ctx[1].filename)
			},
			$$inline: true
		});
	...
	const block = {
		c: function create() {
			...
			t2 = text(t2_value);
			t3 = text(/*Route*/ ctx[0]);
			add_location(h1, file$3, 27, 4, 735);
			add_location(main, file$3, 26, 2, 724);
			add_location(body, file$3, 24, 0, 705);
			attr_dev(html, "lang", "en");
			add_location(html, file$3, 22, 0, 646);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			const head_changes = {};
			if (dirty & /*node*/ 2) head_changes.title = /*makeTitle*/ ctx[2](/*node*/ ctx[1].filename);
			head.$set(head_changes);
			if ((!current || dirty & /*node*/ 2) && t2_value !== (t2_value = /*node*/ ctx[1].filename + "")) set_data_dev(t2, t2_value);
			if (!current || dirty & /*Route*/ 1) set_data_dev(t3, /*Route*/ ctx[0]);
		},
...
function instance$3($$self, $$props, $$invalidate) {
	...
	$$self.$set = $$props => {
		...
		if ("allNodes" in $$props) $$invalidate(3, allNodes = $$props.allNodes);
	};
	...
	return [Route, node, makeTitle, allNodes];
}

class Html extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { Route: 0, node: 1, allNodes: 3 });
		...
		if (/*allNodes*/ ctx[3] === undefined && !("allNodes" in props)) {
...
/* layout/ejected/Router.svelte generated by Svelte v3.20.1 */
...
function instance$4($$self, $$props, $$invalidate) {
	...
	function track(obj) {
		...
		$$invalidate(1, node = Content.getNode(uri));
		$$invalidate(2, allNodes = Content.getAllNodes());
	}

	addEventListener("replacestate", track);
	addEventListener("pushstate", track);
	addEventListener("popstate", track);
	const router = Navaid("/").on("/", () => import('./Index-880ea1a4.js').then(draw)).on("/:slug", () => Promise.resolve().then(function () { return Pages$1; }).then(draw)).on("/blog/:slug", () => import('./BlogPosts-d192e6d5.js').then(draw)).listen();
...
export { SvelteComponentDev as S, app as a, add_location as b, insert_dev as c, dispatch_dev as d, element as e, detach_dev as f, validate_each_argument as g, empty as h, init as i, space as j, create_component as k, attr_dev as l, append_dev as m, noop as n, mount_component as o, set_data_dev as p, transition_in as q, transition_out as r, safe_not_equal as s, text as t, destroy_component as u, validate_slots as v, destroy_each as w };
//# sourceMappingURL=main-c8a7d5a9.js.map
