...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(a, file, 12, 3, 346);
			add_location(br, file, 13, 3, 395);
		},
...
function create_each_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(11:1) {#each allNodes as node}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img, file, 6, 1, 82);
			add_location(h1, file, 7, 1, 133);
			attr_dev(a, "href", "https://svelte.dev/tutorial");
			add_location(a, file, 8, 14, 163);
			add_location(p, file, 8, 1, 150);
			add_location(h3, file, 9, 1, 261);
			attr_dev(section, "id", "intro");
			add_location(section, file, 5, 0, 60);
		},
...
//# sourceMappingURL=Index-ba240588.js.map
