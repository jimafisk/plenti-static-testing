...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-a2d457b1.js').then(draw)).on("/:slug", () => import('./pages-8e03887b.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-cd69a1e0.js').then(draw)).listen();
...
//# sourceMappingURL=main-cf4fcf7a.js.map
