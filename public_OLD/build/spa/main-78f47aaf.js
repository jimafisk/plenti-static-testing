...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file$2, 14, 4, 267);
			add_location(summary, file$2, 16, 6, 312);
			add_location(pre, file$2, 17, 6, 363);
			add_location(details, file$2, 15, 4, 296);
			add_location(main, file$2, 13, 2, 256);
			add_location(body, file$2, 11, 0, 237);
			attr_dev(html, "lang", "en");
			add_location(html, file$2, 9, 0, 178);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-e2e5de79.js').then(draw)).on("/:slug", () => import('./Pages-ed6b5a56.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-c1626299.js').then(draw)).listen();
...
//# sourceMappingURL=main-78f47aaf.js.map
