...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(nav, "class", "svelte-b6cehy");
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(footer, "class", "svelte-1sy5cz");
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(summary, file$3, 16, 8, 352);
			add_location(pre, file$3, 17, 8, 405);
			add_location(details, file$3, 15, 6, 334);
			attr_dev(div, "class", "container");
			add_location(div, file$3, 14, 4, 304);
			attr_dev(main, "class", "svelte-1iwuh2d");
			add_location(main, file$3, 13, 2, 293);
			attr_dev(body, "class", "svelte-1iwuh2d");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-b7c636f3.js').then(draw)).on("/:slug", () => import('./pages-365288d7.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-9e8a9e18.js').then(draw)).listen();
...
//# sourceMappingURL=main-4ae681ef.js.map
