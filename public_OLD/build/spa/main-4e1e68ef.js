...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(footer, "class", "svelte-qefzj");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-f479975b.js').then(draw)).on("/:slug", () => import('./pages-9d2985a2.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-9c84789e.js').then(draw)).listen();
...
//# sourceMappingURL=main-4e1e68ef.js.map
