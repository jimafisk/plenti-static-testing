...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-4cec7d26.js').then(draw)).on("/:slug", () => import('./pages-6ef0fa9c.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-6fc6ced1.js').then(draw)).listen();
...
//# sourceMappingURL=main-acb183c2.js.map
