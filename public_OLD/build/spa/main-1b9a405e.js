...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-259fea72.js').then(draw)).on("/:slug", () => import('./pages-edcd3f5a.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-288cc947.js').then(draw)).listen();
...
//# sourceMappingURL=main-1b9a405e.js.map
