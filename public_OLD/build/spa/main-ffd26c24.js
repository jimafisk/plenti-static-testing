...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-eb2cdf8c.js').then(draw)).on("/:slug", () => import('./pages-7f497423.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-fa911414.js').then(draw)).listen();
...
//# sourceMappingURL=main-ffd26c24.js.map
