...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file$2, 13, 4, 264);
			add_location(summary, file$2, 15, 6, 309);
			add_location(pre, file$2, 16, 6, 360);
			add_location(details, file$2, 14, 4, 293);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-052b19e2.js').then(draw)).on("/:slug", () => import('./Pages-1d97682a.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-f9b05851.js').then(draw)).listen();
...
//# sourceMappingURL=main-1166f0f5.js.map
