...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-ec88024b.js').then(draw)).on("/:slug", () => import('./pages-abf36351.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-a865de7e.js').then(draw)).listen();
...
//# sourceMappingURL=main-94c280f6.js.map
