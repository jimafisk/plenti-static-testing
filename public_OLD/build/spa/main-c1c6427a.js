...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(nav, "class", "svelte-g97i7h");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-d5ed9097.js').then(draw)).on("/:slug", () => import('./pages-9f3d76c6.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-384e209f.js').then(draw)).listen();
...
//# sourceMappingURL=main-c1c6427a.js.map
