...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./Index-2fbbe7f9.js').then(draw)).on("/:slug", () => import('./Pages-014e4f8b.js').then(draw)).on("/blog/:slug", () => import('./BlogPosts-6c215cf3.js').then(draw)).listen();
...
//# sourceMappingURL=main-033ba770.js.map
