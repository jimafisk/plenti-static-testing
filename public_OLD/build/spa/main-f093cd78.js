...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(footer, "class", "svelte-1r80lf6");
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-v4flhd");
			add_location(main, file$3, 13, 2, 293);
			attr_dev(body, "class", "svelte-v4flhd");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-3cf34d6e.js').then(draw)).on("/:slug", () => import('./pages-f9d29780.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-e8d60928.js').then(draw)).listen();
...
//# sourceMappingURL=main-f093cd78.js.map
