...
function instance$3($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-47544986.js').then(draw)).on("/:slug", () => import('./pages-65656722.js').then(draw)).on("/blog/:slug", () => import('./blog_posts-cb9fa923.js').then(draw)).listen();
...
//# sourceMappingURL=main-cf1fd423.js.map
