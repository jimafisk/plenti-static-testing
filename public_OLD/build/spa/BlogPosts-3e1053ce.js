...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(strong0, file, 8, 7, 125);
			add_location(span0, file, 8, 30, 148);
			add_location(div0, file, 8, 2, 120);
			add_location(strong1, file, 9, 7, 182);
			add_location(span1, file, 9, 29, 204);
			add_location(div1, file, 9, 2, 177);
			add_location(div2, file, 7, 0, 112);
			attr_dev(a, "href", "/");
			add_location(a, file, 12, 3, 248);
			add_location(p1, file, 12, 0, 245);
			add_location(span2, file, 14, 0, 279);
		},
...
//# sourceMappingURL=BlogPosts-3e1053ce.js.map
