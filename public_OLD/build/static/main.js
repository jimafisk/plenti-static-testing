...
const Client_router = internal.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	const router = Navaid("/").on("/", () => new Promise(function (resolve) { resolve(require('./index-e6ecaa09.js')); }).then(draw)).on("/:slug", () => new Promise(function (resolve) { resolve(require('./pages-8c73701b.js')); }).then(draw)).on("/blog/:slug", () => new Promise(function (resolve) { resolve(require('./blog-9faff0da.js')); }).then(draw)).listen();
