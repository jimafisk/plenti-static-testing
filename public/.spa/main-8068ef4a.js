...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-409e3d67.js').then(draw)).on("/:slug", () => import('./pages-d4345e74.js').then(draw)).on("/blog/:slug", () => import('./blog-09bfdbc1.js').then(draw)).listen();
	const writable_props = [];
...
//# sourceMappingURL=main-8068ef4a.js.map
