...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(link2, "href", "/special/bundle.css");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-108e6574.js').then(draw)).on("/:slug", () => import('./pages-3f5ea89e.js').then(draw)).on("/blog/:slug", () => import('./blog-ac114957.js').then(draw)).listen();

	//.on('/', () => import('index.js').then(draw))
	//.on('/:slug', () => import('pages.js').then(draw))
	//.on('/blog/:slug', () => import('blog.js').then(draw))
...
//# sourceMappingURL=main-b655b8e7.js.map
