...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(link2, "href", "/.spa/bundle.css");
...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-0f132531.js').then(draw)).on("/:slug", () => import('./pages-1092a5fb.js').then(draw)).on("/blog/:slug", () => import('./blog-9bcb0277.js').then(draw)).listen();
...
//# sourceMappingURL=main-4283a66c.js.map
