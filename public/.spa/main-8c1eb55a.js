...
function instance$4($$self, $$props, $$invalidate) {
	...
	const router = Navaid("/").on("/", () => import('./index-bf3c5b17.js').then(draw)).on("/:slug", () => import('./pages-0fe1eb58.js').then(draw)).on("/blog/:slug", () => import('./blog-3ceb95c1.js').then(draw)).listen();
...
//# sourceMappingURL=main-8c1eb55a.js.map
